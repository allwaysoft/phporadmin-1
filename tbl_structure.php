...
*/
$fields_rs = 
    PMA_DBI_query('SELECT * FROM ALL_TAB_COLUMNS WHERE OWNER LIKE \'' 
                  . ($db) . '\' AND TABLE_NAME LIKE \''
...
<tr>
    ...
    <th id="th<?php echo ++$i; ?>" class="length"><?php echo __('Length(bytes)'); ?></th>
    <th id="th<?php echo ++$i; ?>" class="precision"><?php echo __('Precesion'); ?></th>
...
<tr class="<?php echo $odd_row ? 'odd': 'even'; $odd_row = !$odd_row; ?>">
    ...
    <td nowrap="nowrap" class="data_precision"><?php echo $data_precision; ?></td>
    <td nowrap="nowrap" class="data_scale"><?php echo $data_scale; ?></td>
    <td><?php echo (($row['Null'] == 'Y') ? __('Yes') : __('No')); ?></td>
...
if ($cfg['ShowStats']) {
    ...
    <tr class="tblFooters">
        <td colspan="3" align="center">
            <a href="sql.php?<?php echo $url_query; ?>&pos=1&amp;sql_query=<?php echo urlencode('OPTIMIZE TABLE ' . PMA_backquote($table)); ?>"><?php
            if ($cfg['PropertiesIconic']) {
