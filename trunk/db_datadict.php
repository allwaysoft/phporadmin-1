...
$rowset = PMA_DBI_query("SELECT TABLE_NAME FROM ALL_USER WHERE OWNER LIKE '" . $db . "'", null, PMA_DBI_QUERY_STORE);
...
while ($row = PMA_DBI_fetch_assoc($rowset)) {
     ...
     */
    $result      = PMA_DBI_query('SELECT COLUMN_NAME FROM ALL_TAB_COLUMNS WHERE OWNER LIKE \'' . $db . '\' AND TABLE_NAME LIKE \'' . ($table) . '\'', null, PMA_DBI_QUERY_STORE);
    ...
    if (PMA_MYSQL_INT_VERSION < 50025) {
        ...
        $show_create_table1 = PMA_DBI_fetch_value(
